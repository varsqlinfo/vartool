package com.vartool.web.configuration.scheduler;
...
import com.vartool.web.app.scheduler.listener.JobsListenerImpl;
import com.vartool.web.app.scheduler.listener.TriggerListenerImpl;
...
public class QuartzConfig {
	...
	public Properties quartzProperties() {
		...
		propertiesFactoryBean.setLocation(VartoolConfiguration.getInstance().getQuartzConfig());
		...
		try {
			...
			logger.warn("Cannot load quartz config path : {} , msg: {} " , VartoolConfiguration.getInstance().getQuartzConfig(), e.getMessage(), e);
		}
		return properties;
	}
}
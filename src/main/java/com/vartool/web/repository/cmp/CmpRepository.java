...
public interface CmpRepository extends DefaultJpaRepository, JpaRepository<CmpEntity, Long>, JpaSpecificationExecutor<CmpEntity>  {
	...
	@Query(value = "select new com.vartool.web.dto.response.CmpResponseDTO("+CmpEntity.CMP_ID+", "+CmpEntity.NAME+", "+CmpEntity.CMP_TYPE+", "+CmpEntity.LOG_PATTERN+", "+CmpEntity.DESCRIPTION+","+CmpEntity.CMP_CREDENTIAL+") from CmpEntity m")

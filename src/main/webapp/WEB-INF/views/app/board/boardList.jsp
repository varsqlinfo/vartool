...
<div class="display-off" id="appViewArea">
	...
	<div>
		...
		<div style="float:right;">
			<a href="<vartool:boardUrl addUrl="write"/>" class="btn btn-default"> 새 글쓰기</a>
		</div>
...
VartoolAPP.vueServiceBean({
	...
	,methods:{
		...
		,viewItem : function(item){
			location.href='<vartool:boardUrl addUrl="view"/>?articleId='+item.articleId;  
		}
		,search : function(no){
			var _this = this; 
			...
			this.$ajax({
				url: '<vartool:boardUrl addUrl="list" contextPath="false"/>' 
				,data: param

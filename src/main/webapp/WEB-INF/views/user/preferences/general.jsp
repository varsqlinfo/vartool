				...
				<div>
					<form id="writeForm" name="writeForm" role="form" class="form-horizontal">
						...
						<div class="form-group">
				            ...
				            <div class="col-lg-10">
				                <input type="text" class="form-control" id="orgNm" name="orgNm" value="${detailInfo.orgNm}" placeholder="<spring:message code="join.form.organization"/>"/>
				            </div>
						</div>
						<div class="form-group">
...
(function (){
	var generalMain = {
				...
				fields: {
					uname : {
						validators: {
							...
							,stringLength: { min: 3, max: 100, message: VARTOOL.messageFormat('vartool.form.0004',{range : '3~100'}) }
						}
				  	}
					,uemail : {
						validators: {
							notEmpty: { message: VARTOOL.messageFormat('vartool.form.0001')}
							,stringLength: { min: 0, max: 500, message: VARTOOL.messageFormat('vartool.form.0004',{range : '0~250'}) }
							,emailAddress: {
					...
					,udept : {
						validators: {
							stringLength: { min: 0, max: 120, message: VARTOOL.messageFormat('vartool.form.0004',{range : '0~120'}) }
					  }
				  	}
				}
		...
		,saveInfo : function (){
			...
			VARTOOL.req.ajax({
				url: {type:VARTOOL.uri.user, url:'/preferences/userInfoSave'},
				data:params,

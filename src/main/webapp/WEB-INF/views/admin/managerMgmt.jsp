...
<div class="col-lg-12">
    <h1 class="page-header"><spring:message code="admin.menu.managermgmt" text="매니저 관리" /></h1>
</div>
<div class="row display-off" id="vartoolVueArea">
	<div class="col-sm-6">
				...
				<div class="table-responsive">
					<div id="dataTables-example_wrapper"
						...
						<table
							...
							<thead>
								<tr role="row">
									<th tabindex="0" rowspan="1" colspan="1" style="width: 195px;"><spring:message code="label.name" /></th>
									<th tabindex="0" rowspan="1" colspan="1" style="width: 150px;"><spring:message code="label.id" /></th>
									<th tabindex="0" rowspan="1" colspan="1" style="width: 179px;"><spring:message code="label.dept" /></th>
								</tr>
							</thead>
							<tbody>
...
VartoolAPP.vueServiceBean( {
	...
	,methods:{
		...
		,userSearch : function(no){
			...
			this.$ajax({
				url : {type:VARTOOL.uri.admin, url:'/managerMgmt/userList'}
				,data : param
		...
		,managerSearch : function(no){
			...
			this.$ajax({
				url : {type:VARTOOL.uri.admin, url:'/managerMgmt/managerList'}
				,data : param
				,success: function(resData) {
		...
		,roleAction : function (item,mode){
            ...
            _this.$ajax({
                data:param
                ,url : {type:VARTOOL.uri.admin, url:'/managerMgmt/managerRoleMgmt'}
                ,success:function (resData){
                	_this.userSearch();
                	_this.managerSearch();
                }

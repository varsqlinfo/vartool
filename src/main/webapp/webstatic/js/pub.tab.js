...
;(function ($, window, document) {
	...
	Plugin.prototype ={
		...
		,setActive: function (item){
			var tabId = item[this.options.itemKey.id]; 
			var tabEle= this.tabElement.find('.pubTab-item[data-tab-id="'+tabId+'"]');

			this.removeTabBlink(tabId);
		...
		*/
		...
		,removeTabBlink : function (itemId){
			var tabEle= this.tabElement.find('.pubTab-item[data-tab-id="'+itemId+'"]');
